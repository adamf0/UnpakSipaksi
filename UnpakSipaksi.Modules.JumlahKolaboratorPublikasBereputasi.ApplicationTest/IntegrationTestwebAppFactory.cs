        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<JumlahKolaboratorPublikasBereputasiDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<JumlahKolaboratorPublikasBereputasiDbContext>(options =>
                {
