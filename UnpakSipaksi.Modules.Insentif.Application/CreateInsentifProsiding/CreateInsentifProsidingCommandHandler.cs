...
namespace UnpakSipaksi.Modules.Insentif.Application.CreateInsentifProsiding
{
    ...
    : ICommandHandler<CreateInsentifProsidingCommand, Guid>
    {
        public async Task<Result<Guid>> Handle(CreateInsentifProsidingCommand request, CancellationToken cancellationToken)
        {
            ...
            Result<Domain.Insentif.Insentif> result = Domain.Insentif.Insentif.CreateInsentifProsiding(
                request.Nidn,
