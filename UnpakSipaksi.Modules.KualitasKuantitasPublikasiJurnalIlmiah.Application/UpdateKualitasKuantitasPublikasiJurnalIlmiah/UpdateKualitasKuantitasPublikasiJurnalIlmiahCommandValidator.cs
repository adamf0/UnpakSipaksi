...
{
    public sealed class UpdateKualitasKuantitasPublikasiJurnalIlmiahCommandValidator : AbstractValidator<UpdateKualitasKuantitasPublikasiJurnalIlmiahCommand>
    {
        public UpdateKualitasKuantitasPublikasiJurnalIlmiahCommandValidator()
        {
            RuleFor(c => c.Uuid)
