...
namespace UnpakSipaksi.Modules.PenelitianHibah.Presentation.PenelitianHibah
{
    internal static class UpdateSubstansiUsulan
    {
        ...
        {
            app.MapPut("PenelitianHibah/SubstansiUsulan", [IgnoreAntiforgeryToken(Order = 1001)]  async ([FromForm] UpdateSubstansiUsulanRequest request, ISender sender, IFileProvider fileProvider, HttpContext context) =>
            {
                ...
                .Accepts<UpdateSubstansiUsulanRequest>("multipart/form-data")
                .DisableAntiforgery();
        }

        internal sealed class UpdateSubstansiUsulanRequest
        {
