...
{
    internal class DeleteKualitasKuantitasPublikasiJurnalIlmiah
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapDelete("KualitasKuantitasPublikasiJurnalIlmiah/{Uuid}", async (string Uuid, ISender sender) =>
            {
                Result result = await sender.Send(
                    new DeleteKualitasKuantitasPublikasiJurnalIlmiahCommand(Uuid)
                );
