...
namespace UnpakSipaksi.Modules.KuantitasStatusKi.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KuantitasStatusKiDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KuantitasStatusKiDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kuantitas_status_ki`;
                CREATE TABLE `kuantitas_status_ki` (
