...
{
    public class KuantitasStatusKiTests
    {
        [Fact]
        public void Create_WhenValidPropertiesProvided_ShouldReturnKategoriWithCorrectProperties()
        {
            ...
            // Act
            var result = Domain.KuantitasStatusKi.KuantitasStatusKi.Create(
                nama,
                nilai
            );
        ...
        public void Create_WhenValidPropertiesProvided_ShouldRaiseKategoriCreatedDomainEvent()
        {
            ...
            // Assert
            result.Value.DomainEvents.Should().Contain(e => e is KuantitasStatusKiCreatedDomainEvent);
        }
    }
}
