...
{
    public sealed class UpdateKredibilitasMitraDukunganCommandValidator : AbstractValidator<UpdateKredibilitasMitraDukunganCommand>
    {
        public UpdateKredibilitasMitraDukunganCommandValidator()
        {
            RuleFor(c => c.Uuid)
