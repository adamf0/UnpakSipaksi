...
{
    internal sealed class CreateSubstansiInternalCommandHandler(
    ...
    : ICommandHandler<CreateSubstansiInternalCommand, Guid>
    {
        public async Task<Result<Guid>> Handle(CreateSubstansiInternalCommand request, CancellationToken cancellationToken)
        {
            ...
            Result<SubstansiInternal> result = SubstansiInternal.Create(
