...
namespace UnpakSipaksi.Modules.InovasiPemecahanMasalah.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<InovasiPemecahanMasalahDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<InovasiPemecahanMasalahDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `inovasi_pemecahan_masalah`;
                CREATE TABLE `inovasi_pemecahan_masalah` (
