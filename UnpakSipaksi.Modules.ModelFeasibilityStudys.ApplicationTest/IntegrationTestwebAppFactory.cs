...
namespace UnpakSipaksi.Modules.ModelFeasibilityStudys.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<ModelFeasibilityStudysDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<ModelFeasibilityStudysDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `model_feasibility_study`;
                CREATE TABLE `model_feasibility_study` (
