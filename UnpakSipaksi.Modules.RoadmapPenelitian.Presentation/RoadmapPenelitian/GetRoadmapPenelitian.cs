...
{
    internal static class GetRoadmapPenelitian
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapGet("RoadmapPenelitian/{id}", async (Guid id, ISender sender) =>
            {
                Result<RoadmapPenelitianResponse> result = await sender.Send(new GetRoadmapPenelitianQuery(id));
