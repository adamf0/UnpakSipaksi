...
{
    public sealed class UpdateKejelasanPembagianTugasTimCommandValidator : AbstractValidator<UpdateKejelasanPembagianTugasTimCommand>
    {
        public UpdateKejelasanPembagianTugasTimCommandValidator()
        {
            RuleFor(c => c.Uuid)
