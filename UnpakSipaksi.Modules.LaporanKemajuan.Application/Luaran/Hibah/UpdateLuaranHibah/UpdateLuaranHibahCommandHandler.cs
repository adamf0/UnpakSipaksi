...
{
    internal sealed class UpdateLuaranHibahCommandHandler(
    IDokumenHibahRepository repository,
    IPenelitianHibahApi penelitianHibahApi,
    IUnitOfWorkDokumenHibah unitOfWork)
    : ICommandHandler<UpdateLuaranHibahCommand>
    {
        public async Task<Result> Handle(UpdateLuaranHibahCommand request, CancellationToken cancellationToken)
        {
