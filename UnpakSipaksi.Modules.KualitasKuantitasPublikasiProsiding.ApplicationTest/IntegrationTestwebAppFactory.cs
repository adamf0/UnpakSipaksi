...
namespace UnpakSipaksi.Modules.KualitasKuantitasPublikasiProsiding.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KualitasKuantitasPublikasiProsidingDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KualitasKuantitasPublikasiProsidingDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kualitas_kuantitas_publikasi_prosiding`;
                CREATE TABLE `kualitas_kuantitas_publikasi_prosiding` (
