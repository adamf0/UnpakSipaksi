...
{
    public sealed class UpdateKesesuaianSolusiMasalahMitraValidator : AbstractValidator<UpdateKesesuaianSolusiMasalahMitraCommand>
    {
        public UpdateKesesuaianSolusiMasalahMitraValidator()
        {
            RuleFor(c => c.Uuid)
