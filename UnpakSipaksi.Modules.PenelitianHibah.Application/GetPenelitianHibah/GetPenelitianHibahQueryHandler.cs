...
{
    internal sealed class GetPenelitianHibahQueryHandler(IDbConnectionFactory dbConnectionFactory)
    : IQueryHandler<GetPenelitianHibahQuery, PenelitianHibahResponse>
    {
        public async Task<Result<PenelitianHibahResponse>> Handle(GetPenelitianHibahQuery request, CancellationToken cancellationToken)
        {
            ...
            PenelitianHibahResponse data = new PenelitianHibahResponse
            {
                ...
                Skema = result.IdSkema?.ToString() == null ? null : new SkemaResponse
                {
                ...
                Riset = (result.IdPrioritasRiset?.ToString() == null && result.IdFokusPenelitian?.ToString() == null) ? null : new RisetResponse
                {
                ...
                RumpunIlmu = result.IdRumpunIlmu1?.ToString() == null ? null : new RumpunIlmuResponse
                {
