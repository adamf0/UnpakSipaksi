...
{
    public sealed class UpdateDokumenPendukungCommandValidator : AbstractValidator<UpdateDokumenPendukungCommand>
    {
        public UpdateDokumenPendukungCommandValidator()
        {
            RuleFor(c => c.Uuid)
