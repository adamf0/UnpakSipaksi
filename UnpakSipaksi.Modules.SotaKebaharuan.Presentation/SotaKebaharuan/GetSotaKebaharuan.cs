...
{
    internal static class GetSotaKebaharuan
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapGet("SotaKebaharuan/{id}", async (Guid id, ISender sender) =>
            {
                Result<SotaKebaharuanResponse> result = await sender.Send(new GetSotaKebaharuanQuery(id));
