...
namespace UnpakSipaksi.Modules.PotensiKetercapaianLuaranDijanjikan.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<PotensiKetercapaianLuaranDijanjikanDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<PotensiKetercapaianLuaranDijanjikanDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `potensi_ketercapaian_luaran_dijanjikan`;
                CREATE TABLE `potensi_ketercapaian_luaran_dijanjikan` (
