...
{
    public sealed class UpdateModelFeasibilityStudysCommandValidator : AbstractValidator<UpdateModelFeasibilityStudysCommand>
    {
        public UpdateModelFeasibilityStudysCommandValidator()
        {
            RuleFor(c => c.Uuid)
