...
namespace UnpakSipaksi.Modules.SotaKebaharuan.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<SotaKebaharuanDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<SotaKebaharuanDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `sota_kebaharuan`;
                CREATE TABLE `sota_kebaharuan` (
