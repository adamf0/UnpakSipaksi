...
namespace UnpakSipaksi.Modules.JumlahKolaboratorPublikasBereputasi.Application.DeleteJumlahKolaboratorPublikasBereputasi
{
    ...
    : ICommandHandler<DeleteJumlahKolaboratorPublikasBereputasiCommand>
    {
        ...
        {
            Domain.JumlahKolaboratorPublikasBereputasi.JumlahKolaboratorPublikasBereputasi? existingJumlahKolaboratorPublikasBereputasi = await jumlahKolaboratorPublikasBereputasiRepository.GetAsync(request.uuid, cancellationToken);

            if (existingJumlahKolaboratorPublikasBereputasi is null)
            {
                return Result.Failure(JumlahKolaboratorPublikasBereputasiErrors.NotFound(request.uuid));
            }
