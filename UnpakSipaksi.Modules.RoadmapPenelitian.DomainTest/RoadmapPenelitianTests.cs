...
{
    public class RoadmapPenelitianTests
    {
        [Fact]
        public void Create_WhenValidPropertiesProvided_ShouldReturnKategoriWithCorrectProperties()
        {
            ...
            // Act
            var result = Domain.RoadmapPenelitian.RoadmapPenelitian.Create(
                nama,
                skor
            );
        ...
        public void Create_WhenValidPropertiesProvided_ShouldRaiseKategoriCreatedDomainEvent()
        {
            ...
            // Assert
            result.Value.DomainEvents.Should().Contain(e => e is RoadmapPenelitianCreatedDomainEvent);
        }
    }
}
