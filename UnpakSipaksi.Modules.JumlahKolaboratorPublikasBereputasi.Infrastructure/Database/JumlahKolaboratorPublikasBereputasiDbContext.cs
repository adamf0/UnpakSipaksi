...
namespace UnpakSipaksi.Modules.JumlahKolaboratorPublikasBereputasi.Infrastructure.Database
{
    public sealed class JumlahKolaboratorPublikasBereputasiDbContext(DbContextOptions<JumlahKolaboratorPublikasBereputasiDbContext> options) : DbContext(options), IUnitOfWork
    {
        ...
        {
            modelBuilder.Entity<Domain.JumlahKolaboratorPublikasBereputasi.JumlahKolaboratorPublikasBereputasi>().ToTable(Schemas.JumlahKolaboratorPublikasBereputasi);
            modelBuilder.ApplyConfiguration(new JumlahKolaboratorPublikasBereputasiConfiguration());

            modelBuilder.Entity<Domain.JumlahKolaboratorPublikasBereputasi.JumlahKolaboratorPublikasBereputasi>(entity =>
            {
                var guidConverter = new ValueConverter<Guid, string>(
                    v => v.ToString("D"), // Mengonversi Guid ke string dengan format "N" (tidak ada tanda hubung)
                    v => Guid.ParseExact(v, "D") // Mengonversi string kembali menjadi Guid
                );
                entity.ToTable(Schemas.JumlahKolaboratorPublikasBereputasi);
