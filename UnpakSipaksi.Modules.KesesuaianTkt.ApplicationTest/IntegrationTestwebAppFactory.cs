...
namespace UnpakSipaksi.Modules.KesesuaianTkt.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KesesuaianTktDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KesesuaianTktDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kesesuaian_tkt`;
                CREATE TABLE `kesesuaian_tkt` (
