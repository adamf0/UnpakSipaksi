...
namespace UnpakSipaksi.Modules.KredibilitasMitraDukungan.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KredibilitasMitraDukunganDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KredibilitasMitraDukunganDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kredibilitas_mitra_dukungan`;
                CREATE TABLE `kredibilitas_mitra_dukungan` (
