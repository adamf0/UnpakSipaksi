...
namespace UnpakSipaksi.Modules.RelevansiKualitasReferensi.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<RelevansiKualitasReferensiDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<RelevansiKualitasReferensiDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `relevansi_kualitas_referensi`;
                CREATE TABLE `relevansi_kualitas_referensi` (
