...
namespace UnpakSipaksi.Modules.RoadmapPenelitian.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<RoadmapPenelitianDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<RoadmapPenelitianDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `roadmap_penelitian`;
                CREATE TABLE `roadmap_penelitian` (
