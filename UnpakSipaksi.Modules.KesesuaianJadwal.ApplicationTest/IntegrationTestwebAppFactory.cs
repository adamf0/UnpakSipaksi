...
namespace UnpakSipaksi.Modules.KesesuaianJadwal.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KesesuaianJadwalDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KesesuaianJadwalDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kesesuaian_jadwal`;
                CREATE TABLE `kesesuaian_jadwal` (
