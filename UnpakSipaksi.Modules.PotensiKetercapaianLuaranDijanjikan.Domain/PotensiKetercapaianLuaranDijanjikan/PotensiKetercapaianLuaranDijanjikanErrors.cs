...
namespace UnpakSipaksi.Modules.PotensiKetercapaianLuaranDijanjikan.Domain.PotensiKetercapaianLuaranDijanjikan
{
    public static class PotensiKetercapaianLuaranDijanjikanErrors
    {
        ...
        public static Error NotSameValue() =>
            Error.NotFound("PotensiKetercapaianLuaranDijanjikan.NotSameValue", "not the same value in data 'skor'");
        ...
        public static Error InvalidValueSkor() =>
            Error.NotFound("PotensiKetercapaianLuaranDijanjikan.InvalidValueSkor", "Invalid value 'skor'");
