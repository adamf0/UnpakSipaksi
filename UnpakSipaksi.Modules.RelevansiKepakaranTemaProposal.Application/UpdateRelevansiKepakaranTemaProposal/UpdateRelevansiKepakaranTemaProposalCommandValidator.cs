...
{
    public sealed class UpdateRelevansiKepakaranTemaProposalCommandValidator : AbstractValidator<UpdateRelevansiKepakaranTemaProposalCommand>
    {
        public UpdateRelevansiKepakaranTemaProposalCommandValidator()
        {
            RuleFor(c => c.Uuid)
