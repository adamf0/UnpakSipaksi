...
{
    public sealed class UpdateMetodeRencanaKegiatanCommandValidator : AbstractValidator<UpdateMetodeRencanaKegiatanCommand>
    {
        public UpdateMetodeRencanaKegiatanCommandValidator()
        {
            RuleFor(c => c.Uuid)
