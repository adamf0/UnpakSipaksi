...
namespace UnpakSipaksi.Modules.KelompokRab.DomainTest
{
    public class KelompokRabTests
    {
        ...
        public void Create_WhenValidPropertiesProvided_ShouldReturnKategoriWithCorrectProperties()
        {
            ...
            // Act
            var result = Domain.KelompokRab.KelompokRab.Create(
                nama
            );
        ...
        public void Create_WhenValidPropertiesProvided_ShouldRaiseKategoriCreatedDomainEvent()
        {
            ...
            // Assert
            result.Value.DomainEvents.Should().Contain(e => e is KelompokRabCreatedDomainEvent);
        }
    }
}
