        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<RumusanPrioritasMitraDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<RumusanPrioritasMitraDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            // var script = await File.ReadAllTextAsync(sqlFilePath);
             var script = """
                DROP TABLE IF EXISTS `rumusan_prioritas_mitra`;
                CREATE TABLE `rumusan_prioritas_mitra` (
