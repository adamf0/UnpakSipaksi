...
{
    internal sealed class GetPenelitianPkmDefaultQueryHandler(IDbConnectionFactory dbConnectionFactory)
    : IQueryHandler<GetPenelitianPkmDefaultQuery, PenelitianPkmDefaultResponse>
    {
        public async Task<Result<PenelitianPkmDefaultResponse>> Handle(GetPenelitianPkmDefaultQuery request, CancellationToken cancellationToken)
        {
            ...
            if (result == null)
            {
                return Result.Failure<PenelitianPkmDefaultResponse>(PenelitianPkmErrors.NotFound(Guid.Parse(request.PenelitianPkmUuid)));
            }

            PenelitianPkmDefaultResponse data = new PenelitianPkmDefaultResponse
            {
