...
namespace UnpakSipaksi.Modules.KesesuaianPenugasan.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KesesuaianPenugasanDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KesesuaianPenugasanDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kesesuaian_penugasan`;
                CREATE TABLE `kesesuaian_penugasan` (
