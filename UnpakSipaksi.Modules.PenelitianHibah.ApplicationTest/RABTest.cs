    ...
    public class RABTest : BaseIntegrationTest
    {
        ...
        public async Task CreateRAB_ShouldBeSuccess_WhenValidData()
        {
            ...
            typeof(Domain.PenelitianHibah.PenelitianHibah)
                .GetProperty(nameof(Domain.PenelitianHibah.PenelitianHibah.Id))!
                .SetValue(hibahEntity, penelitianHibahId);

            typeof(Domain.PenelitianHibah.PenelitianHibah)
                .GetProperty(nameof(Domain.PenelitianHibah.PenelitianHibah.Uuid))!
