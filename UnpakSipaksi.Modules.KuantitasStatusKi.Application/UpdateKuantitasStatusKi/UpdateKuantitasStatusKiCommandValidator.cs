...
{
    public sealed class UpdateKuantitasStatusKiCommandValidator : AbstractValidator<UpdateKuantitasStatusKiCommand>
    {
        public UpdateKuantitasStatusKiCommandValidator()
        {
            RuleFor(c => c.Uuid)
