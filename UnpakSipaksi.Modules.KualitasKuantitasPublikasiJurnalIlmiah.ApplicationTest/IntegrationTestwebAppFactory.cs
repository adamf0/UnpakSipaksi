        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KualitasKuantitasPublikasiJurnalIlmiahDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KualitasKuantitasPublikasiJurnalIlmiahDbContext>(options =>
                {
