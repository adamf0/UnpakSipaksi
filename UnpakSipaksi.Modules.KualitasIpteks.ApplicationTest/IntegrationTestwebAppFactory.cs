...
namespace UnpakSipaksi.Modules.KualitasIpteks.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KualitasIpteksDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KualitasIpteksDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kualitas_ipteks`;
                CREATE TABLE `kualitas_ipteks` (
