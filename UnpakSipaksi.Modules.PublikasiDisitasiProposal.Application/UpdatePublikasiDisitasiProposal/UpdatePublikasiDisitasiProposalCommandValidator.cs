...
{
    public sealed class UpdatePublikasiDisitasiProposalCommandValidator : AbstractValidator<UpdatePublikasiDisitasiProposalCommand>
    {
        public UpdatePublikasiDisitasiProposalCommandValidator()
        {
            RuleFor(c => c.Uuid)
