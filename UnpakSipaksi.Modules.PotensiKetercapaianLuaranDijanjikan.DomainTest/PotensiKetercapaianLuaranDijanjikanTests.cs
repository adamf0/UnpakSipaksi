...
{
    public class PotensiKetercapaianLuaranDijanjikanTests
    {
        [Fact]
        public void Create_WhenValidPropertiesProvided_ShouldReturnKategoriWithCorrectProperties()
        {
            ...
            // Act
            var result = Domain.PotensiKetercapaianLuaranDijanjikan.PotensiKetercapaianLuaranDijanjikan.Create(
                nama,
                skor
            );
        ...
        public void Create_WhenValidPropertiesProvided_ShouldRaiseKategoriCreatedDomainEvent()
        {
            ...
            // Assert
            result.Value.DomainEvents.Should().Contain(e => e is PotensiKetercapaianLuaranDijanjikanCreatedDomainEvent);
        }
    }
}
