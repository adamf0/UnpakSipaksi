...
namespace UnpakSipaksi.Modules.PenelitianPkm.DomainTest.Luaran
{
    public class LuaranTests
    {
        ...
        public async Task Create_ShouldSucceed_WhenValid()
        {
            ...
            result.Value.PenelitianPkmId.Should().Be(10);
        ...
        private static async Task<Domain.PenelitianPkm.PenelitianPkm> DummyHibah(int id)
        {
