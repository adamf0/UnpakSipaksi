...
namespace UnpakSipaksi.Modules.PenelitianPkm.DomainTest.RAB
{
    public class RABTests
    {
        ...
        public async void Create_ShouldSucceed_WhenValidInput()
        {
            ...
            var hibah = await Domain.PenelitianPkm.PenelitianPkm.Create(mockRepo.Object, "1234567890", "2024-01-01", "judul");
        ...
        [Fact]
        public void Create_ShouldFail_WhenPenelitianPkmIsNull()
        {
        ...
        public async void Update_ShouldSucceed_WhenValid()
        {
            ...
            var result = Domain.RAB.RAB.Update(
                uuid: existing.Uuid,
                UuidPenelitianPkm: Guid.NewGuid(),
                existingPenelitianPkm: hibah.Value,
                prev: existing,
                KelompokRabId: 1,
                KomponenId: 2,
                Item: 3,
        ...
        {
            // Arrange
            var mockRepo1 = new Mock<IPenelitianPkmRepository>();
            mockRepo1.Setup(x =>
                x.HasUniqueDataAsync(
                    It.IsAny<Guid?>(),
                    It.Is<string>(s => s == "1234567890"),
            ...
            var mockRepo2 = new Mock<IPenelitianPkmRepository>();
            mockRepo2.Setup(x =>
                x.HasUniqueDataAsync(
                    It.IsAny<Guid?>(),
                    It.Is<string>(s => s == "1234567890"),
            ...
            var hibah1 = await Domain.PenelitianPkm.PenelitianPkm.Create(mockRepo1.Object, "1234567890", "2024-01-01", "judul1");
            var hibah2 = await Domain.PenelitianPkm.PenelitianPkm.Create(mockRepo2.Object, "1234567890", "2024-01-01", "judul2");
            ...
            var result = Domain.RAB.RAB.Update(
                uuid: existing.Uuid,
                UuidPenelitianPkm: Guid.NewGuid(),
                existingPenelitianPkm: hibah2.Value, // different ID
                prev: existing,
                KelompokRabId: 1,
                KomponenId: 2,
                Item: 2,
