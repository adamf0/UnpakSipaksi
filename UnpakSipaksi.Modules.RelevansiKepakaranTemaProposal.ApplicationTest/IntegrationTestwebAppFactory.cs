...
namespace UnpakSipaksi.Modules.RelevansiKepakaranTemaProposal.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<RelevansiKepakaranTemaProposalDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<RelevansiKepakaranTemaProposalDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `relevansi_kepakaran_tema_proposal`;
                CREATE TABLE `relevansi_kepakaran_tema_proposal` (
