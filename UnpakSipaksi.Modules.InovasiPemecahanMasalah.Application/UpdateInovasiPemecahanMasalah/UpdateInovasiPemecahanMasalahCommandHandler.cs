...
namespace UnpakSipaksi.Modules.InovasiPemecahanMasalah.Application.UpdateInovasiPemecahanMasalah
{
    ...
    : ICommandHandler<UpdateInovasiPemecahanMasalahCommand>
    {
        ...
        {
            Domain.InovasiPemecahanMasalah.InovasiPemecahanMasalah? existingInovasiPemecahanMasalah = await inovasiPemecahanMasalahRepository.GetAsync(Guid.Parse(request.Uuid), cancellationToken);
