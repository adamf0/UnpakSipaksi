...
namespace UnpakSipaksi.Modules.PublikasiDisitasiProposal.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<PublikasiDisitasiProposalDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<PublikasiDisitasiProposalDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `publikasi_disitasi_proposal`;
                CREATE TABLE `publikasi_disitasi_proposal` (
