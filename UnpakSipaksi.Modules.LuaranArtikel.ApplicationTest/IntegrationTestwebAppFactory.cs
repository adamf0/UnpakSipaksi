        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<LuaranArtikelDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<LuaranArtikelDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            // var script = await File.ReadAllTextAsync(sqlFilePath);
             var script = """
                DROP TABLE IF EXISTS `luaran_artikel`;
                CREATE TABLE `luaran_artikel` (
