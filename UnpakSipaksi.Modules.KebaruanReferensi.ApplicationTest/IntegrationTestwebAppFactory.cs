...
namespace UnpakSipaksi.Modules.KebaruanReferensi.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KebaruanReferensiDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KebaruanReferensiDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kebaruan_referensi`;
                CREATE TABLE `kebaruan_referensi` (
