...
namespace UnpakSipaksi.Modules.RelevansiKepakaranTemaProposal.Domain.RelevansiKepakaranTemaProposal
{
    public static class RelevansiKepakaranTemaProposalErrors
    {
        ...
        public static Error NotSameValue() =>
           Error.NotFound("RelevansiKepakaranTemaProposal.NotSameValue", "not the same value in data 'skor'");
        ...
        public static Error InvalidValueSkor() =>
            Error.NotFound("RelevansiKepakaranTemaProposal.InvalidValueSkor", "Invalid value 'skor'");
