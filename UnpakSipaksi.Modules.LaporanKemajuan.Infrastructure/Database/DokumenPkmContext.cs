...
{
    public sealed class DokumenPkmContext(DbContextOptions<DokumenPkmContext> options) : DbContext(options), IUnitOfWorkDokumenPkm
    {
        internal DbSet<Domain.Dokumen.Dokumen> DokumenPkm { get; set; }
