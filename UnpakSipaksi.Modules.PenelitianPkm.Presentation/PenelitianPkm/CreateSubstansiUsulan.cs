...
namespace UnpakSipaksi.Modules.PenelitianPkm.Presentation.PenelitianPkm
{
    internal static class CreateSubstansiUsulan
    {
        ...
        {
            app.MapPost("PenelitianPkm/SubstansiUsulan", [IgnoreAntiforgeryToken(Order = 1001)] async ([FromForm] CreateSubstansiUsulanPkmRequest request, ISender sender, IFileProvider fileProvider, HttpContext context, TokenValidator tokenValidator) =>
            {
              ...
              .Accepts<CreateSubstansiUsulanPkmRequest>("multipart/form-data")
              .DisableAntiforgery();
        }

        internal sealed class CreateSubstansiUsulanPkmRequest
        {
