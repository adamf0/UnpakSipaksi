...
{
    internal static class UpdateDokumenLainnya
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPut("PenelitianPkm/DokumenLainnya", [IgnoreAntiforgeryToken(Order = 1001)]  async ([FromForm] UpdateDokumenLainnyaRequest request, ISender sender, IFileProvider fileProvider, HttpContext context) =>
            {
                ...
                Result result = await sender.Send(new UpdateDokumenLainnyaCommand(
                    request.Uuid,
                ...
                .Accepts<UpdateDokumenLainnyaRequest>("multipart/form-data")
                .DisableAntiforgery();
        }

        internal sealed class UpdateDokumenLainnyaRequest
        {
