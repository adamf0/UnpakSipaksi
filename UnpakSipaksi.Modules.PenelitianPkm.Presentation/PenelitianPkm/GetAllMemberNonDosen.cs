...
using UnpakSipaksi.Modules.PenelitianPkm.Application.GetAllMemberNonDosen;
...
namespace UnpakSipaksi.Modules.PenelitianPkm.Presentation.PenelitianPkm
{
    internal static class GetAllMemberNonDosen
    {
        ...
        {
            app.MapGet("PenelitianPkm/MemberNonDosen/{UuidPenelitianPkm}", async (string UuidPenelitianPkm, ISender sender) =>
            {
                Result<List<MemberNonDosenResponse>> result = await sender.Send(new GetAllMemberNonDosenQuery(UuidPenelitianPkm));
