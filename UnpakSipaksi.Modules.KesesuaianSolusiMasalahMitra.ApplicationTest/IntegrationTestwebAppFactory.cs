...
namespace UnpakSipaksi.Modules.KesesuaianSolusiMasalahMitra.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KesesuaianSolusiMasalahMitraDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KesesuaianSolusiMasalahMitraDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `kesesuaian_solusi_masalah_mitra`;
                CREATE TABLE `kesesuaian_solusi_masalah_mitra` (
