...
namespace UnpakSipaksi.Modules.KetajamanAnalisis.ApplicationTest
{
        ...
        : WebApplicationFactory<Program>, IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KetajamanAnalisisDbContext>));
                if (descriptor != null)
                {
                ...
                services.AddDbContext<KetajamanAnalisisDbContext>(options =>
                {
        ...
        public async Task InitializeAsync()
        {
            ...
            var script = """
                DROP TABLE IF EXISTS `ketajaman_analisis`;
                CREATE TABLE `ketajaman_analisis` (
