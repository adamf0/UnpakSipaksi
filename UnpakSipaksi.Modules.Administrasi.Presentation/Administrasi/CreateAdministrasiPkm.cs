...
using UnpakSipaksi.Modules.Administrasi.Application.CreateAdministrasiPkm;
...
{
    internal static class CreateAdministrasiPkm
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost("AdministrasiPkm", async (CreateAdministrasiPkmRequest request, ISender sender) =>
            {
                Result<Guid> result = await sender.Send(new CreateAdministrasiPkmCommand(
        ...
        internal sealed class CreateAdministrasiPkmRequest
        {
