...
using UnpakSipaksi.Modules.Administrasi.Application.CreateAdministrasiInternal;
using UnpakSipaksi.Modules.Administrasi.Presentation;

namespace UnpakSipaksi.Modules.Administrasi.Presentation.AdministrasiInternal
{
    internal static class CreateAdministrasiInternal
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost("AdministrasiInternal", async (CreateAdministrasiInternalRequest request, ISender sender) =>
            {
                Result<Guid> result = await sender.Send(new CreateAdministrasiInternalCommand(
                    request.UuidPenelitianInternal,
                    request.Level,
                    request.Judul,
        ...
        internal sealed class CreateAdministrasiInternalRequest
        {
            public string UuidPenelitianInternal { get; set; }
