...
{
    public sealed class UpdateRelevansiProdukKepentinganNasionalCommandValidator : AbstractValidator<UpdateRelevansiProdukKepentinganNasionalCommand>
    {
        public UpdateRelevansiProdukKepentinganNasionalCommandValidator()
        {
            RuleFor(c => c.Uuid)
