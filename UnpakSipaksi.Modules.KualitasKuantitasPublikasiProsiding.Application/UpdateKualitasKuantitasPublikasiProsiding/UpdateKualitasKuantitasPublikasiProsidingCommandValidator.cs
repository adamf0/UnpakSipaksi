...
{
    public sealed class UpdateKualitasKuantitasPublikasiProsidingCommandValidator : AbstractValidator<UpdateKualitasKuantitasPublikasiProsidingCommand>
    {
        public UpdateKualitasKuantitasPublikasiProsidingCommandValidator()
        {
            RuleFor(c => c.Uuid)
